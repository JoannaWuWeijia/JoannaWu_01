...
gdf = gpd.read_file("https://raw.githubusercontent.com/fedhere/PUI2015_EC/master/mam1612_EC/nyc-zip-code-tabulation-areas-polygons.geojson")
...
Cuisine_Violation_Category_Table.plot(kind='bar', stacked=True, figsize=(12, 8))
...
Neighborhood_Violation_Category_Table.plot(kind='bar', stacked=True, figsize=(12, 8))
